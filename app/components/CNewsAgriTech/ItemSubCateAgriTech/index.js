...
class ItemSubCateAgriTech extends React.Component { 
  onClickEdit=()=>{
  ...
  viewDetail=()=>{
    if(this.props.data){
      this.props.getName(this.props.data.nameSubCate)
    }
  }
  render() {
    let name = null;
    let link = null;
    if(this.props.data){
      name = this.props.data.nameSubCate;
...
ItemSubCateAgriTech.propTypes = {

};

export default ItemSubCateAgriTech;

...
var et = false;
var detail = false;
class BauCua extends React.Component { 
  constructor(props) {
    super(props);
    this.state = {
      isMobile: false,
    ...
    if(this.props.data && (this.props.data.length > 0 || this.props.data.size > 0)){
      ...
      print = (
        <div  style={{marginTop: '2%',marginLeft:'5%'}}>
          <Workbook filename={"Mini_Game_Bầu_Cua_"+this.props.st+"_"+this.props.et+".xlsx"} element={<Button type="primary">Xuất file</Button>}>
            <Workbook.Sheet data={print_data} name="Lịch sử mini game : Bầu cua">
              ...
              <Workbook.Column label="Tổng tiền đặt" value={r=>this.props.formatCurency(r.betValue)}/>             
              ...
              <Workbook.Column label="Tổng tiền nhận" value={r=>this.props.formatCurency(r.prizeValue)}/>             
        ...
        table=(
          ...
          <tbody>
            <tr style={{background:'rgb(236, 246, 253)',fontStyle:'italic'}}>
              ...
              <th style={{height:40,border:'1px solid #e2e2e2',fontSize:13,textAlign:'center'}}>Tổng tiền đặt</th>
              ...
              <th style={{height:40,border:'1px solid #e2e2e2',fontSize:13,textAlign:'center'}}>Tổng tiền nhận</th>
            ...
            detail_slot = (
              <div>
                ...
                <tr>
                  ...
                  <td style={{height:40,border:'1px solid #e2e2e2',fontSize:13,textAlign:'left',padding:5}}>{r.id}</td>                  
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <th style={{height:40,border:'1px solid #e2e2e2',fontSize:13,textAlign:'left',padding:5}}>Tổng tiền đặt</th>
                  ...
                  <tr>
                    <th style={{height:40,border:'1px solid #e2e2e2',fontSize:13,textAlign:'left',padding:5}}>Tổng tiền nhận</th>

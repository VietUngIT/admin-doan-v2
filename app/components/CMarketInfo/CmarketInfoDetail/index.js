...
import ModalAddNewsMK from 'components/CMarketInfo/ModalAddNewsMK'
...
class CmarketInfoDetail extends React.Component {
  ...
  handleModalDelOk=()=>{
    this.props.deleteNewsMK(this.props.data[0].id)
  ...
  onChangeTitle=(e)=>{
    this.props.changeTitleNewsMK(e.target.value)
  }
  onChangeAuthor=(e)=>{
    this.props.changeAuthorNewsMK(e.target.value)
  }
  onChangeSource=(e)=>{
    this.props.changeSourceNewsMK(e.target.value)
  }
  onChangeIdCate=(e)=>{
    this.props.changeIdCateNewsMK(e.target.value)
  }
  addTags=()=>{
  ...
  changeImageHandle(){
    if(this.props.imageEdit && this.props.imageEdit.toString().indexOf("data\:image")>-1 && this.props.imageEdit.toString().indexOf(";base64")>-1){
      this.props.editImageNewsMK(this.props.data[0].id);
    }else{
  ...
  onChangeContent=(e)=>{
    ...
    this.props.changeContentNewsMK(content)
  }
  submitEditNewsClick=()=>{
    this.setState({modalEdit: true,});
  }
  handleModalEditOk=()=>{
    this.props.submitEditNewsMK(this.props.data[0].id,this.props.data[0].idCateNews)
      ...
      if(this.props.listCate && (this.props.listCate.size >0 || this.props.listCate.length>0)){
        ...
        modalAdd = (
          <ModalAddNewsMK modalAddNews={this.state.modalAddNews} handleCloseModalAdd={this.handleCloseModalAdd}
            listCate={this.props.listCate} errorCode={this.props.errorCode} idcate={this.props.data[0].idCateNews}
            addNewsMK={this.props.addNewsMK}/>
        )
      }
    }else{
